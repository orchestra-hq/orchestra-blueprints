...
{%- set event_names = ['page_view', 'page_ping'] -%}
{%- set flat_cols = ['app_id', 'domain_sessionid', 'domain_sessionidx', 'domain_userid', 'geo_city', 'geo_country', 'geo_region', 'page_title', 'page_url', 'platform', 'refr_urlhost'] -%}
{%- set sde_cols = [] -%}
{%- set sde_keys = [] -%}
{%- set sde_types = [] -%}
{%- set sde_aliases = [] -%}
