...
Environment variables consumed:
    ...
    LINEAR_CYCLES_SINCE_DAYS             Lookback window in days for ``updatedAt`` (default 84 = 12 weeks).
...
def run_pipeline(since_days: int = 84) -> None:
...
if __name__ == "__main__":
    days = int(os.getenv("LINEAR_CYCLES_SINCE_DAYS", "84"))
